...
constexpr MotorPropaties MOTOR1_PROPS = {3, 2, 250};
constexpr MotorPropaties MOTOR2_PROPS = {5, 6, 150};
constexpr MotorPropaties MOTOR3_PROPS = {46, 8, 150};
constexpr MotorPropaties MOTOR4_PROPS = {9, 10, 150};
...
constexpr ConvergerPropaties CONVERGER1_PROPS = {60, 40, 1, 5};
